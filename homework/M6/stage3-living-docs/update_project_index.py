...
EXCLUDE_DIRS = {
    ...
    # Local-only / runtime dirs that are not part of the committed source map
    "assignments", "qdrant_storage", ".ollama-home", ".ollama-models", "uploads",
    "skills",
}

# Files to skip
# CLAUDE.md and .env are local-only here (AGENTS.md is the canonical rules file;
# .env is gitignored) — keep them out of the committed map.
EXCLUDE_FILES = {".DS_Store", "*.pyc", "CLAUDE.md", ".env"}
