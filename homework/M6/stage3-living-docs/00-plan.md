...
- **Existing docs surface:** `AGENTS.md`, `README.md`, `DESIGN.md`, `FINDINGS.md`, `docs/architecture.md`, `docs/adr/0001..0003`, `design-system/`.
...
- ✅ Keep / additive: 6 (`docs/adr/`, `docs/architecture.md`, `README.md`, `AGENTS.md`, `DESIGN.md`, `design-system/`)
- 🔄 Update + keep: 0
